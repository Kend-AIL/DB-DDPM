...
result_dir = "/mnt/datasets/CMR/MICCAIChallenge2023/result_without_kspace_200"
...
#inference check
from improved_diffusion.sampling_util import sampling_without_kspace
...
dataset = MRIdata(data_dir, patient_list,tsfm,mask_num=1)

sampling_without_kspace(val_bs, diffusion, model, result_dir, dataset, logger, True, vote_num=4)
